...
DFIR4vSphere was first presented at the [CoRI&IN 2022](https://conf.cecyf.fr/event/1/contributions/1/) (Conférence sur la réponse aux incidents et l’investigation numérique). Slides of the presentation, in french language,  are available [here](https://www.cert.ssi.gouv.fr/uploads/TLP_White_CoRIIN_ANSSI-SDO-DR.pdf).
